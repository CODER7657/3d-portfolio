        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CYBERSECURITY</h3>
              <h4>Securing Digital Assets</h4>
              <p>
                Specializing in quantum-resistant encryption, network security, and penetration testing 
                to safeguard infrastructure against current and future vulnerabilities.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Cryptography</div>
                <div className="what-tags">Kyber-1024</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Engineering scalable smart contracts, DApps, and DeFi protocols.
                Bridging traditional systems with web3 and ensuring on-chain security.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Truffle</div>
